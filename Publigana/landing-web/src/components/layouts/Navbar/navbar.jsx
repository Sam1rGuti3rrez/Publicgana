...
function Navbar() {
  return (
    <header className="sticky top-0 z-50 border-b border-[rgba(246,241,231,0.14)] bg-[rgba(31,17,71,0.85)] backdrop-blur-[10px]">
      <div className="flex items-center justify-between px-[24px] py-[18px]">
        ...
        <button
          ...
          className="hidden border-none bg-transparent p-0 text-[1.5rem] text-[#F6F1E7] min-[0px]:max-[880px]:block focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#F5A623]"
        >
