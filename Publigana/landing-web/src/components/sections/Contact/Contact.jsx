...
import { registrarLead } from "../../../services/LeadService";
...
console.error(error);
setErrorMessage(error.message || "No fue posible registrar tu interés.");
} finally {
...
Estamos validando el modelo en Bogotá con negocios y usuarios reales.
Déjanos tus datos y te avisamos en cuanto haya campañas disponibles
en tu zona.
</p>
</div>
...
<label
htmlFor="nombre"
className="text-[0.85rem] font-[600] text-[#C9C0DE]"
>
Nombre completo
</label>
...
>
{isSubmitting ? "Enviando..." : "Registrar mi interés"}
</button>
...
{errorMessage && (
<div className="rounded-[12px] border border-[rgba(239,68,68,0.4)] bg-[rgba(239,68,68,0.12)] p-[18px] text-[0.95rem] text-[#F6F1E7]">
{errorMessage}
</div>
)}
</form>
